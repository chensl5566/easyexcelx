...
import com.github.chensl5566.excel.ExcelReader;
...
public class Read2007Xlsx {
    ...
    @Test
    public void testMyTrans() {

        AnalysisEventListener<MyEntity> listener = new AnalysisEventListener<MyEntity>() {
            @Override
            public void invoke(MyEntity object, AnalysisContext context) {
        ...
        try {
            excelReader = new ExcelReader(new BufferedInputStream(new FileInputStream(new File("/Users/chensonglin/Downloads/myentity.xlsx"))), null, listener);
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        excelReader.read(new Sheet(1, 1, MyEntity.class));
